...
function findRelation(text: string): RelationCfg | undefined {
...
type WifeAction = 'card' | 'set' | 'add' | 'list' | 'photo';

function parseAction(text: string): { action: WifeAction; param: string } {
