...
import { ELEMENT_COLORS, STAR_COLORS, FONT_FAMILY, DARK_BG, formatDateZh, CONS_COLORS } from './shared.js';
        ...
        React.createElement("div", { style: {
            ...
            avatar.artifacts &&
                ...
                (() => {
                    ...
                    return (React.createElement("div", { style: { padding: '0 24px 14px' } },
                        ...
                        React.createElement("div", { style: {
                            ...
                            React.createElement("div", { style: { display: 'flex', alignItems: 'center', gap: '8px' } },
                                React.createElement("span", { style: { fontSize: '12px', color: '#aaa' } }, "\u603B\u8BC4\u5206"),
                                React.createElement("span", { style: {
                                        fontSize: '18px',
                                        fontWeight: 'bold',
                            ...
                            React.createElement("div", { style: { display: 'flex', alignItems: 'center', gap: '8px' } },
                                React.createElement("span", { style: { fontSize: '12px', color: '#aaa' } }, "\u5E73\u5747"),
                                React.createElement("span", { style: { fontSize: '14px', fontWeight: 'bold', color: '#fff' } }, totalScore.avgMark),
                                React.createElement("span", { style: {
                                        fontSize: '13px',
                                        fontWeight: 'bold',
                                        color: totalScore.grade.color,
                        ...
                        avatar.artifacts.map(art => (React.createElement(ArtifactItem, { key: art.pos, art: art, charName: avatar.name })))));
                })(),
            React.createElement("div", { style: {
