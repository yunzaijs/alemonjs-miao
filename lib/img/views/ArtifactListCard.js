...
import { FONT_FAMILY, DARK_BG, formatDateZh, STAR_COLORS } from './shared.js';
        ...
        React.createElement("div", { style: {
            ...
            React.createElement("div", { style: {
                ...
                React.createElement("div", { style: {
                    ...
                    game === 'sr' ? '遗器' : '圣遗物',
                    "\u8BC4\u5206\u6392\u5E8F")),
            React.createElement("div", { style: { padding: '14px 20px' } }, scored.length > 0 ? (scored.map(({ av, score }) => React.createElement(CharArtifactRow, { key: av.id, avatar: av, game: game, score: score }))) : (React.createElement("div", { style: {
                    width: '100%',
                    textAlign: 'center',
                    padding: '40px 0',
                    color: '#666',
