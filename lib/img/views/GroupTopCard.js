...
import { ELEMENT_COLORS, STAR_COLORS, FONT_FAMILY, FONT_NZBZ, contStyle, contTitleStyle, formatDateZh } from './shared.js';
import fileUrl from '../../assets/common/bg-01.jpg.js';
import fileUrl$1 from '../../assets/common/main-01.png.js';
import fileUrl$2 from '../../assets/common/crown.png.js';
        ...
        React.createElement("div", { style: {
            ...
            React.createElement("div", { style: {
                ...
                React.createElement("div", { style: { borderRadius: '15px', padding: '10px 20px', color: '#fff', marginTop: '10px', display: 'flex', alignItems: 'center', gap: '10px' } },
                    React.createElement("img", { src: fileUrl$2, style: { width: '28px', height: '28px' } }),
