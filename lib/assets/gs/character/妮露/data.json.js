...
var star = 5;
var elem = "hydro";
var allegiance = "祖拜尔剧场";
var weapon = "sword";
var birth = "12-3";
var astro = "睡莲座";
var desc = "祖拜尔剧场的知名舞者，舞姿灵动优美，为人纯真亲善。";
var cncv = "紫苏九月";
var jpcv = "金元寿子";
var costume = [
	207001
...
var cons = {
	...
	"2": {
		name: "星天的花雨",
		desc: [
			"处于「金杯的丰馈」状态下的角色对敌人造成水元素伤害后，该敌人的水元素抗性降低35%，持续10秒；对敌人造成绽放或月绽放反应伤害后，该敌人的草元素抗性降低35%，持续10秒。",
			"需要解锁突破天赋「折旋落英之庭」。"
		]
	},
	"3": {
...
var passive = [
	...
	},
	{
		...
		desc: [
			...
			"处于金杯的丰馈状态下的角色受到草元素攻击会使附近的所有角色元素精通提升100点，持续10秒；此外，触发绽放或月绽放反应时，将取代草原核产生「丰穰之核」。",
...
export { abbr, allegiance, astro, attr, baseAttr, birth, cncv, cons, costume, char36 as default, desc, elem, eta, growAttr, id, jpcv, materials, name, passive, star, talent, talentCons, talentData, talentId, title, ver, weapon };
