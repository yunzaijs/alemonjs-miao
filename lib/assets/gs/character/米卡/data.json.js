...
var birth = "8-11";
var astro = "林鸽座";
var desc = "平凡家庭出身的年轻骑士，在小队中担任「前进测绘员」一职。为人低调，谨小慎微。";
var cncv = "邓宥希";
var jpcv = "三瓶由布子";
var costume = false;
var ver = 1;
...
var cons = {
	...
	"2": {
		name: "伴行的旅路",
		desc: [
			"星霜的流旋的霜流矢首次命中敌人时，或是冰星信标命中敌人时，将产生1层突破天赋「速射牵制」的侦明效果。",
			"需要解锁突破天赋「速射牵制」。"
		]
	},
	"3": {
	...
	"6": {
		name: "依随的策援",
		desc: [
			"星霜的流旋灵风状态下的侦明效果叠加层数上限提升1层。需要解锁突破天赋「速射牵制」。",
...
var passive = [
	...
	},
	{
		name: "地貌测绘",
		desc: [
			"同时处于苍翎的颂愿的鹰翎状态与星霜的流旋的灵风状态下的当前场上角色，在攻击造成暴击时，灵风状态将产生1层突破天赋「速射牵制」的侦明效果。在一次灵风状态的持续期间内，通过这种方式至多产生1层侦明效果。",
...
export { abbr, allegiance, astro, attr, baseAttr, birth, cncv, cons, costume, char75 as default, desc, elem, eta, growAttr, id, jpcv, materials, name, passive, star, talent, talentCons, talentData, talentId, title, ver, weapon };
