...
var birth = "1-3";
var astro = "浪客座";
var desc = "身份成谜的流浪人士。衣着打扮像是修验者，言行却并不是修验者应有的模样。";
var cncv = "鹿喑";
var jpcv = "柿原彻也";
var costume = false;
var ver = 1;
...
var cons = {
	...
	"4": {
		name: "四番·花月歌浮舟",
		desc: [
			"施放羽画·风姿华歌时，若触发了突破天赋「拾玉得花」依据元素类型强化的效果，还将随机获得1种本次施放未触发的强化效果。同时至多获得3种元素对应的强化效果。",
			"需要解锁突破天赋「拾玉得花」。"
		]
	},
	"5": {
...
export { abbr, allegiance, astro, attr, baseAttr, birth, cncv, cons, costume, char54 as default, desc, elem, eta, growAttr, id, jpcv, materials, name, passive, star, talent, talentCons, talentData, talentId, title, ver, weapon };
