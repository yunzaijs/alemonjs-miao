...
var birth = "12-18";
var astro = "原海巨灵座";
var desc = "枫丹的最高审判官，因其无懈可击的「秉公无私」而闻名。";
var cncv = "桑毓泽";
var jpcv = "神谷浩史";
var costume = false;
var ver = 1;
...
var cons = {
	"1": {
		name: "尊荣的创定",
		desc: [
			"那维莱特登场时，获得一层突破天赋「古海孑遗的权柄」的「遗龙之荣」。需要解锁突破天赋「古海孑遗的权柄」。",
	...
	"2": {
		name: "律法的命诫",
		desc: [
			"突破天赋「古海孑遗的权柄」获得强化：每存在一层「遗龙之荣」，就使重击·衡平推裁的暴击伤害提升14%，至多通过这种方式提升42%。",
			"需要解锁突破天赋「古海孑遗的权柄」。"
		]
	},
	"3": {
...
var passive = [
	...
	},
	{
		name: "古海孑遗的权柄",
		desc: [
			"队伍中的角色对敌人触发蒸发、冻结、感电、月感电、绽放、月绽放、水元素扩散、水元素结晶或月结晶反应时，将为那维莱特产生持续30秒，至多叠加3层的「遗龙之荣」效果，使重击·衡平推裁造成原本110%/125%/160%的伤害。",
...
export { abbr, allegiance, astro, attr, baseAttr, birth, cncv, cons, costume, char105 as default, desc, elem, eta, growAttr, id, jpcv, materials, name, passive, star, talent, talentCons, talentData, talentId, title, ver, weapon };
