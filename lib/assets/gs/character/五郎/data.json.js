...
var cons = {
	...
	"2": {
		name: "犬坐·稳如钟",
		desc: [
			"在大将威仪的持续期间，附近的当前场上角色获取结晶反应产生的晶片或触发月结晶反应后，五郎自己的大将威仪的持续时间延长1秒。",
...
export { abbr, allegiance, astro, attr, baseAttr, birth, cncv, cons, costume, char6 as default, desc, elem, eta, growAttr, id, jpcv, materials, name, passive, star, talent, talentCons, talentData, talentId, title, ver, weapon };
