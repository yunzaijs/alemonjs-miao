...
var birth = "4-22";
var astro = "鼠兔座";
var desc = "纳茨卡延的年轻战士，受赐古名「乌沙博蒂」。善良执着的少女，在挫折中不断成长。";
var cncv = "静宸";
var jpcv = "久保百合花";
var costume = false;
var ver = 1;
...
var cons = {
	"1": {
		...
		desc: [
			...
			"此外，队伍中的角色获取晶片或触发月结晶反应时，将为卡齐娜恢复3点元素能量，每5秒至多通过这种方式恢复一次元素能量。"
		]
	},
	"2": {
		name: "不能少了…冲天转转",
...
export { abbr, allegiance, astro, attr, baseAttr, birth, cncv, cons, costume, char20 as default, desc, elem, eta, growAttr, id, jpcv, materials, name, passive, star, talent, talentCons, talentData, talentId, title, ver, weapon };
