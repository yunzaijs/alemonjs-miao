...
var birth = "8-3";
var astro = "浪海豹座";
var desc = "纳塔远近闻名的向导，水上用品商店的经营者，精通各类水上运动的逐浪客。";
var cncv = "王晓彤";
var jpcv = "东山奈央";
var costume = false;
var ver = 1;
...
var cons = {
	...
	"4": {
		name: "鲨鲨主食是豚豚。",
		desc: [
			"获得豚豚球时，玛拉妮恢复8点元素能量；该效果需要解锁突破天赋「耐热型淡水豚豚」。",
			"此外，爆瀑飞弹造成的伤害提升75%。"
		]
	},
	"5": {
...
export { abbr, allegiance, astro, attr, baseAttr, birth, cncv, cons, costume, char59 as default, desc, elem, eta, growAttr, id, jpcv, materials, name, passive, star, talent, talentCons, talentData, talentId, title, ver, weapon };
