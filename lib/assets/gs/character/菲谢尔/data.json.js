...
var star = 4;
var elem = "electro";
var allegiance = "冒险家协会";
var weapon = "bow";
var birth = "5-27";
var astro = "幻鸦座";
var desc = "自称「断罪之皇女」，与名为奥兹的漆黑夜鸦同行的神秘少女。";
var cncv = "Mace&赵悦程";
var jpcv = "内田真礼&增谷康纪";
var costume = [
	203101
...
var cons = {
	...
	"6": {
		...
		desc: [
			...
			"奥兹进行协同攻击后，魔女的前夜礼·宵世幻奏中提升攻击力与元素精通的效果提高100%，持续10秒。"
		]
	}
};
var passive = [
	...
	},
	{
		name: "魔女的前夜礼·宵世幻奏",
		desc: [
			"完成魔女的课业·意外之题后，菲谢尔将成为魔导角色。队伍中编入至少2名魔导角色时，将获得魔导·秘仪效果，使魔导角色获得强化。",
			"<h3>魔导·秘仪</h3>",
...
export { abbr, allegiance, astro, attr, baseAttr, birth, cncv, cons, costume, char94 as default, desc, elem, eta, growAttr, id, jpcv, materials, name, passive, star, talent, talentCons, talentData, talentId, title, ver, weapon };
